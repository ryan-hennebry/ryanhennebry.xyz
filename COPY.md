...
This is the copy surface for the page. You own the words. Edit anything above the line, tell me when you are done, and I will apply it and re-verify the layout.

Write normal apostrophes. I convert them when applying (they are `&#8217;` in the markup).
...
These are open, not settled. The next session should not assume otherwise.
